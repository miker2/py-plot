...
class QxtSpanSlider(QSlider):
    ...
    def __init__(self, parent=None):
        ...
        print("Style 'Windows': ", QStyleFactory.create('Windows'))
        print("Style 'Fusion': ", QStyleFactory.create('Fusion'))
        print("Style 'Fusion' palette: ", QStyleFactory.create('Fusion').standardPalette())
    ...
    def handleMousePress(self, pos, control, value, handle):
        ...
        self._initStyleOption(opt, handle)
        oldControl = control
        control = self.style().hitTestComplexControl(QStyle.CC_Slider,
                                                     opt, pos, self)
    ...
    def mousePressEvent(self, event):
        ...
        if self.upperPressed != QStyle.SC_SliderHandle:
            self.lowerPressed = self.handleMousePress(event.pos(),
                                                      self.lowerPressed,
                                                      self.lower,
    ...
    def mouseMoveEvent(self, event):
        if self.lowerPressed != QStyle.SC_SliderHandle and \
           self.upperPressed != QStyle.SC_SliderHandle:
            event.ignore()
            return
